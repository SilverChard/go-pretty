# Table
[![Go Reference](https://pkg.go.dev/badge/github.com/silver-chard/go-pretty/v6/table.svg)](https://pkg.go.dev/github.com/silver-chard/go-pretty/v6/table)
...
`go test -v github.com/silver-chard/go-pretty/v6/table` to see the test outputs and
