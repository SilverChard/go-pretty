# Table
[![Go Reference](https://pkg.go.dev/badge/github.com/SilverChard/go-pretty/v6/table.svg)](https://pkg.go.dev/github.com/SilverChard/go-pretty/v6/table)
...
`go test -v github.com/SilverChard/go-pretty/v6/table` to see the test outputs and
